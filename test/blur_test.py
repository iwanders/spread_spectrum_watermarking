...
lengths = [10, 100, 1000, 2000, 4000, 8000]
for i in lengths:
    random.seed(0)
    ...
    for i in [1,1.5, 2.5, 3, 5]:
        ...
        cox.YIQ_DCT_Image(blurreddata).write('blurred.png')

        target_image = cox.YIQ_DCT_Image(blurreddata)
        input_image = cox.YIQ_DCT_Image.open(input_path)
        ...
        print("Testing gaussian blur %f: %s " % (i,res))
